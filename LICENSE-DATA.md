...
All **data files** in this repository (everything under `datasets/**/data/output/`,
in CSV and XLSX form) are licensed under the
...
**Attribution:** Cross, James (2026). *EUR_DATA: Integrating EU studies and Data
